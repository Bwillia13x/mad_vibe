...
export class LoyaltyUITestFramework {
  ...
  private async testCustomerSelectionDropdown(): Promise<LoyaltyUITestResult> {
    ...
    try {
      ...
      await this.page.waitForSelector('[data-testid="customer-select-placeholder"]', { timeout: 5000 });
      ...
      const firstCustomerOption = this.page.locator('[data-testid^="customer-select-"]:not([data-testid="customer-select-placeholder"])').first();
