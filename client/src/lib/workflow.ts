...
export const workflowStages: WorkflowStage[] = [
  {
    ...
    work: [
      "Review latest activity cards",
      "Choose session resume or start new idea"
    ],
    outputs: [
  ...
  },
  {
    ...
    work: [
      "Capture thesis stub",
      "Record business quality impression",
      "List disqualifiers"
    ],
    ...
    aiModes: [
      "Summarize 10-K in 5 bullets",
      "Explain revenue drivers",
      "List contrarian risks"
    ]
  },
  {
    id: 2,
    ...
    work: [
      "Compose natural-language screener",
      "Inspect results against prior runs"
    ],
  ...
  },
  {
    ...
    work: [
      "Model EPV baseline",
      "Run DCF scenarios",
      "Compare relatives and industry models"
    ],
  ...
  },
  {
    ...
    work: [
      "Run sizing math",
      "Check correlation mix",
      "Review liquidity stress"
    ],
...
export const stageIndexBySlug = new Map(
  workflowStages.map((stage) => [stage.slug, stage.id])
)
