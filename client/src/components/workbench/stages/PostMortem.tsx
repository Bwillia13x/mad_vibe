    ...
    <div className="w-full min-h-[calc(100vh-16px)] bg-slate-950 text-slate-100 rounded-xl overflow-hidden ring-1 ring-slate-800">
      ...
      <div className="p-4 grid grid-cols-12 gap-4">
        ...
        <div className="col-span-12 xl:col-span-3 space-y-4">
          ...
          <Card title="Price Path (stub)" subtitle="Entry → exit">
        ...
        <div className="col-span-12 xl:col-span-6 space-y-4">
          ...
          <Card title="Attribution & Errors" subtitle="What worked; what did not">
        ...
        <div className="col-span-12 xl:col-span-3 space-y-4">
          ...
          <Card title="Metrics" subtitle="Sanity overview">
            <ul className="text-sm text-slate-300 space-y-1">
