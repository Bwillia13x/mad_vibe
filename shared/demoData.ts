...
export const businessProfileData: Omit<BusinessProfile, 'id' | 'createdAt' | 'updatedAt'> = {
  ...
  description:
    "Calgary's premier destination for sophisticated men's grooming. Established in Bridgeland, we blend traditional barbering techniques with modern style to deliver an unparalleled grooming experience.",
...
export const servicesData: Array<
  Omit<Service, 'id' | 'createdAt' | 'updatedAt'> & { tempId: string }
> = [
  {
...
export const customersData: Array<
  Omit<Customer, 'id' | 'createdAt' | 'updatedAt'> & { tempId: string }
> = [
  {
    ...
    phone: '(403) 555-0123',
    preferences: {
      preferredBarber: 'Andreas Kowalski',
  ...
  },
  {
    ...
    phone: '(403) 555-0124',
    preferences: {
      preferredBarber: 'Marcus Chen',
      preferredTime: 'afternoon',
      allergies: [],
      notes: 'Modern fade regular'
    }
  },
  {
    ...
    phone: '(403) 555-0125',
    preferences: {
      preferredBarber: 'Sarah MacDonald',
      preferredTime: 'evening',
      allergies: [],
      notes: 'Color touch-ups monthly'
    }
  },
  {
    ...
    phone: '(403) 555-0126',
    preferences: {
      preferredBarber: 'Ryan Thompson',
      preferredTime: 'morning',
      allergies: [],
      notes: 'Traditional shave enthusiast'
    }
  },
  {
    ...
    phone: '(403) 555-0127',
    preferences: {
      preferredBarber: 'David Walsh',
      preferredTime: 'afternoon',
      allergies: [],
      notes: 'Quick trim regular'
    }
  },
  {
    ...
    preferences: {
      ...
      preferredTime: 'morning',
      allergies: [],
      notes: 'Executive package monthly'
    }
  },
  {
